...
public class MainKrKeyboard extends ReplyKeyboardMarkup{
	public MainKrKeyboard(Language language) {
		super();
	    ...
	    keyboardSecondRow.add(MainCommand.HAPPY_LINE.getCommand(language));
